...
<html>
    <head>
        ...
        <title>Staff Registration_Form</title>
                            ...
                            <form action="StaffRegisterServlet" method="post">  
                                ...
                                <div class="form-group row py-2">
                                    <div class="col-4">
                                        ...
                                        <small class="date-field-msg form-text text-danger mx-2">Enter Date of Birth</small>
                                    </div>
                                    <!--Gender //-->
                                    <div class="col-6">
                                ...
                                <div class="form-group row py-2">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="pan form-control" name="pancardNo">
                                ...
                                <div class="form-group row py-2">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control"
                                               id="exampleInputusernamepstmt.setString(1, st.getUsername());" name="username">
                                    </div>
                                </div>
                                <div class="form-group row py-2">
                                    <div class="col-6">
